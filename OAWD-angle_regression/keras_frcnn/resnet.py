...
def classifier(base_layers, input_rois,  aroi_input,num_rois, nb_classes = 21, trainable=False):
    ...
    #out_angle_class = TimeDistributed(Dense(nb_angle_classes, activation='softmax', kernel_initializer='zero'), name='dense_class_{}'.format(nb_angle_classes))(out)
    # note: no regression target for bg class
    #out_regr = TimeDistributed(Dense(4 * (nb_classes-1), activation='linear', kernel_initializer='zero'), name='dense_regress_{}'.format(nb_classes))(out)
    out_regr = TimeDistributed(Dense(5 * (nb_classes-1), activation='linear', kernel_initializer='zero'), name='dense_regress_{}'.format(nb_classes))(out)
    #print("ok2")
    #out_aregr = TimeDistributed(Dense(1 * (nb_classes-1), activation='linear', kernel_initializer='zero'), name='dense_regress_{}'.format(nb_classes))(out)
    #print(out_class.shape)
    #print("ok1")
    #print(out_regr.shape)
    #print(out_angle_class)
